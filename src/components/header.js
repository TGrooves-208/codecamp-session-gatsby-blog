...
const SocialButton = props => {
  ...
  if (props.site === "twitter") {
    ...
    url = "https://twitter.com/TGrooves" + props.username
  } else if (props.site === "linkedin") {
    style = styles.buttonLinkedin
    url = "https://www.linkedin.com/in/gil-aguilar/" + props.username
  } else if (props.site === "github") {
    style = styles.buttonGithub
    url = "https://www.github.com/TGrooves-208" + props.username
  }
    ...
    render={data => (
      <header className={styles.container}>
        <div className={styles.row}>
          ...
          <SocialButton site="github" username=""></SocialButton>
